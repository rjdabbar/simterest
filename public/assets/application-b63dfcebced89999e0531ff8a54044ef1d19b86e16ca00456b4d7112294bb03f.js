...
(function() { this.JST || (this.JST = {}); this.JST["boards/board_form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="screen">\n</div>\n<div class="modal">\n  <div class="modal-content">\n    ');  if(board.id) { ; __p.push('\n      <h3><b>Edit your board</b> ',  board.escape("title") ,'</h3>\n    ');   } else { ; __p.push('\n      <h2>Create a board</h2>\n    ');   } ; __p.push('\n    <form class="board" method="post">\n    <ul class="form-list">\n      <li>\n        <h3><label for="board_title">Title:</label></h3>\n        <div>\n          <input id="board_title"\n                 type="text"\n                 name="board[title]"\n                 value="',  board.escape("title") ,'">\n        </div>\n      </li>\n      <li>\n        <h3><label for="board_description">Description:</label></h3>\n        <div>\n          <textarea id="board_description"\n                    name="board[description]"\n                    rows="8" cols="40">',  board.escape("description") ,'</textarea>\n        </div>\n      </li>\n      <li>\n        <h3><label for="board_category">Category:</label></h3>\n        <div>\n          <select id="board_category" name="board[category]">\n            ');  Simterest.Globals.boardCategories.forEach(function(category) { ; __p.push('\n              <option value="',  category ,'">',  category ,'</option>\n            ');   }); ; __p.push('\n          </select>\n        </div>\n      </li>\n      <li>\n        <h3><label for="board_secret">Secret Board:</label></h3>\n        <div>\n          <input id="board_secret"\n                 type="checkbox"\n                 name="board[secret]"\n                 value="true">\n        </div>\n      </li>\n    </ul>\n      ');  if(board.id) { ; __p.push('\n        <button class="delete">Delete Board</button>\n        <button class="submit">Edit</button>\n      ');   } else { ; __p.push('\n        <button class="submit">Create</button>\n      ');   } ; __p.push('\n        <button class="cancel">Cancel</button>\n    </form>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/board_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="public-board-index group">\n\n</ul>\n<ul class="secret-board-index group">\n\n</ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/board_index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  board.escape("title") ,'</h3>\n<div class="large-pin">\n  <img src="http://lorempixel.com/output/sports-h-c-147-151-6.jpg" alt="" />\n</div>\n<div class="pin-thumbs">\n  <img src="http://lorempixel.com/output/sports-h-c-147-151-6.jpg" alt="" />\n  <img src="http://lorempixel.com/output/sports-h-c-147-151-6.jpg" alt="" />\n  <img src="http://lorempixel.com/output/sports-h-c-147-151-6.jpg" alt="" />\n</div>\n<button class="edit">Edit</button>\n<div class="overlay-light"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["boards/board_new_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('Create a board\n<div class="overlay-dark"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/user_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="content-wrapper">\n  <div class="main-content">\n    <div class="user-show">\n      <h1>',  user.escape("username") ,'</h1>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["utils/header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav>\n  ');  if (signed_in?) { ; __p.push('\n    <a class="profile-link" href="#',  current_user.id ,'">Your Profile</a>\n  ');  } else { ; __p.push('\n      <a href="',  new_session_url ,'">Sign In</a>\n      <a href="',  new_user_url ,'">Sign Up</a>\n  ');  };  ; __p.push('\n</nav>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["utils/profile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
...
"Illustrations and Posters", "Kids and Parenting", "Men's Fashion", "Musics",
"Outdoors", "Photography", "Products", "Quotes", "Science and Nature", "Sports",
"Tattoos", "Technology", "Travel", "Weddings", "Women's Fashion", "Other" ]
;
